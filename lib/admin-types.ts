...
export const INVOICE_COLUMNS =
  "id, created_at, kind, number, status, amount_ht_cents, amount_ttc_cents, issued_at, due_date, service_date, paid_at, payment_method, payment_terms, client_type, client_name, client_email, client_siren, client_address_street, client_postal_code, client_city, client_country, issuer_snapshot, payment_url, stripe_payment_link_id, stripe_ref, project_id";
