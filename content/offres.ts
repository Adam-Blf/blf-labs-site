...
export const OFFRES: Offre[] = [
  {
    ...
    intro:
      "Site vitrine, page de lancement ou boutique en ligne. Vous repartez avec un site rapide, lisible sur téléphone, indexé correctement, et dont vous gardez le code et le nom de domaine.",
    deliverables: [
      "Maquette validée avant la première ligne de code",
      "Site responsive, testé en clair et en sombre",
  ...
  },
  {
    ...
    intro:
      "Quand le fichier partagé atteint ses limites : comptes utilisateurs, droits d'accès, historique, tableau de bord. On modélise votre métier, puis on l'outille.",
    deliverables: [
      "Modèle de données discuté avec vos équipes",
      "Comptes, rôles et droits verrouillés côté base",
      "Tableau de bord et exports",
      "Tests automatisés sur les calculs sensibles",
  ...
  },
  {
    ...
    pitch: "iOS et Android, jusqu'à la publication sur les stores.",
    intro:
      "Une application publiée sur l'App Store et Google Play, pas une démo. Le studio publie déjà ses propres applications, la partie pénible de la publication est déjà balisée.",
    deliverables: [
      "Application iOS et Android",
      "Fiches store, captures et textes de présentation",
      "Publication et suivi des validations",
      "Achats intégrés si le modèle économique en demande",
  ...
  },
  {
    ...
    pitch: "Vos données rangées, vos tâches répétitives supprimées.",
    intro:
      "Récupérer des données éparpillées, les nettoyer, les rendre lisibles. Automatiser ce qui se fait encore à la main. Brancher un modèle de langue quand il apporte vraiment quelque chose.",
    deliverables: [
